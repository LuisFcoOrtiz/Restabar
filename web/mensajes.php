		...
		<div class="main-wrapper" >
			...
			<div class="col-xs-12 col-sm-12 col-md-12 ">		    		
					...
					<div class="alert alert-success" role="alert">
					  ...
					  <center> <h1>Mensajes a cocina<?php echo $mesaEscogida?></h1> <a href='index.php'>  <img src="images/message.png" class="img-responsive" alt="Cinque Terre"> </a> </center>
							...
							<center>	
								...
								<table class="table">
								  <thead class="thead-dark">
									...
									<?php										
										$results=$con->query("SELECT * FROM mensaje_camarero");
										while($row = $results->fetch_assoc()) {	
											$id=$row['ncodmen'];
											$nombre=$row['cnomcam'];
											$puesto=$row['cpuesto'];
											$mensaje=$row['cmensaje'];
											...
											echo "<tbody>
													<tr>
													  ...
													  <td>".$puesto."</td>
													  <td>".$mensaje."</td>
													  <td><img src='images/msg.png' class='img-responsive' alt='Cinque Terre'></td>
													</tr>									
												  </tbody>";
										}
									?>
